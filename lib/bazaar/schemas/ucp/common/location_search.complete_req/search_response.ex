defmodule Bazaar.Schemas.Common.LocationSearchCompleteReq.SearchResponse do
  @moduledoc """
  Schema

  Generated from: location_search.complete_req.json
  """
  use Ecto.Schema
  import Ecto.Changeset
  alias Bazaar.Schemas.Common.Types.LocationCompleteReq
  ...
  embedded_schema do
    ...
    embeds_many(:locations, LocationCompleteReq)
