defmodule Bazaar.Schemas.Common.LocationSearchUpdateReq.SearchResponse do
  @moduledoc """
  Schema
  ...
  alias Bazaar.Schemas.Common.Types.LocationUpdateReq
  ...
  embedded_schema do
    ...
    embeds_many(:locations, LocationUpdateReq)
