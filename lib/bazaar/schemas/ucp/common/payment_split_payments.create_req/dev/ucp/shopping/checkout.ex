defmodule Bazaar.Schemas.Common.PaymentSplitPaymentsCreateReq.DevUcpShoppingCheckout do
  @moduledoc """
  Checkout with Split Payments Create Request

  Checkout extended with split payment instrument amounts.

  Generated from: payment_split_payments.create_req.json
  """
  use Ecto.Schema
