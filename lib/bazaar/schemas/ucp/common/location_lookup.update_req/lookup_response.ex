defmodule Bazaar.Schemas.Common.LocationLookupUpdateReq.LookupResponse do
  @moduledoc """
  Schema

  Generated from: location_lookup.update_req.json
  """
  use Ecto.Schema
  import Ecto.Changeset
  alias Bazaar.Schemas.Common.LocationLookupUpdateReq.LookupLocation
  alias Bazaar.Schemas.UcpUpdateReq.ResponseLocationSchema
