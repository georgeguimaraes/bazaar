defmodule Bazaar.Schemas.Common.LocationLookupCreateReq.LookupRequest do
  @moduledoc """
  Schema
  ...
  Generated from: location_lookup.create_req.json
  """
  use Ecto.Schema
  ...
  alias Bazaar.Schemas.Common.Types.LocationServesCreateReq
  ...
  embedded_schema do
    ...
    embeds_one(:serves, LocationServesCreateReq)
