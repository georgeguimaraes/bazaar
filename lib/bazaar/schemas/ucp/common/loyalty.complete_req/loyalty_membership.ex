defmodule Bazaar.Schemas.Common.LoyaltyCompleteReq.LoyaltyMembership do
  @moduledoc """
  Schema
  ...
  alias Bazaar.Schemas.Common.LoyaltyCompleteReq.MembershipReward
  alias Bazaar.Schemas.Common.LoyaltyCompleteReq.MembershipTier
