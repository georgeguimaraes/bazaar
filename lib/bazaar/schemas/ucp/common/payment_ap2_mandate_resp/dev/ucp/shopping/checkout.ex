defmodule Bazaar.Schemas.Common.PaymentAp2MandateResp.DevUcpShoppingCheckout do
  @moduledoc """
  Checkout with AP2 Mandate Response

  Checkout extended with AP2 mandate support.

  Generated from: payment_ap2_mandate_resp.json
  """
  use Ecto.Schema
  import Ecto.Changeset
  alias Bazaar.Schemas.Common.PaymentAp2MandateResp.Ap2WithCheckoutMandate
