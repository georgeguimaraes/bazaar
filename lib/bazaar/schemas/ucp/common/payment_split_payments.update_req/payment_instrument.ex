defmodule Bazaar.Schemas.Common.PaymentSplitPaymentsUpdateReq.PaymentInstrument do
  @moduledoc """
  Payment Instrument (Split Payments) Update Request

  Payment instrument extended with an optional per-instrument amount for split payments.

  Generated from: payment_split_payments.update_req.json
  """
  use Ecto.Schema
