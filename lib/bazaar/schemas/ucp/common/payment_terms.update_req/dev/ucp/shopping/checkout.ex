defmodule Bazaar.Schemas.Common.PaymentTermsUpdateReq.DevUcpShoppingCheckout do
  @moduledoc """
  Checkout with Payment Terms Update Request
  ...
  alias Bazaar.Schemas.Common.PaymentTermsUpdateReq.Payment
