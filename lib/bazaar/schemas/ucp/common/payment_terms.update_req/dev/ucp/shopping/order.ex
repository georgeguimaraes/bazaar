defmodule Bazaar.Schemas.Common.PaymentTermsUpdateReq.DevUcpShoppingOrder do
  @moduledoc """
  Order with Accepted Payment Term Update Request
  ...
  alias Bazaar.Schemas.Common.PaymentTermsUpdateReq.OrderPayment
