defmodule Bazaar.Schemas.Common.LoyaltyCreateReq.MembershipReward do
  @moduledoc """
  Schema
  ...
  alias Bazaar.Schemas.Common.LoyaltyCreateReq.EarningForecast
  alias Bazaar.Schemas.Common.LoyaltyCreateReq.RewardCurrency
