defmodule Bazaar.Schemas.Common.LoyaltyResp.MembershipReward do
  @moduledoc """
  Schema
  ...
  alias Bazaar.Schemas.Common.LoyaltyResp.EarningForecast
  alias Bazaar.Schemas.Common.LoyaltyResp.RewardCurrency
