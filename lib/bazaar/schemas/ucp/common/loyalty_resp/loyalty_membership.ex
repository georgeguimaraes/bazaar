defmodule Bazaar.Schemas.Common.LoyaltyResp.LoyaltyMembership do
  @moduledoc """
  Schema
  ...
  alias Bazaar.Schemas.Common.LoyaltyResp.MembershipReward
  alias Bazaar.Schemas.Common.LoyaltyResp.MembershipTier
