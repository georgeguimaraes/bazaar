defmodule Bazaar.Schemas.Common.LocationSearchResp.SearchRequest do
  @moduledoc """
  Schema
  ...
  alias Bazaar.Schemas.Common.Types.LocationServesResp
  ...
  embedded_schema do
    ...
    embeds_one(:serves, LocationServesResp)
