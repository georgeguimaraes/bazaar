defmodule Bazaar.Schemas.Common.LocationSearchResp.SearchResponse do
  @moduledoc """
  Schema

  Generated from: location_search_resp.json
  """
  use Ecto.Schema
  import Ecto.Changeset
  alias Bazaar.Schemas.Common.Types.LocationResp
  alias Bazaar.Schemas.Common.Types.Pagination.Response
  alias Bazaar.Schemas.UcpResp.ResponseLocationSchema
  ...
  embedded_schema do
    ...
    embeds_many(:locations, LocationResp)
