defmodule Bazaar.Schemas.Common.PaymentTermsResp.DevUcpShoppingCheckout do
  @moduledoc """
  Checkout with Payment Terms Response
  ...
  alias Bazaar.Schemas.Common.PaymentTermsResp.Payment
