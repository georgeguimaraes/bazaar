defmodule Bazaar.Schemas.Common.PaymentTermsResp.DevUcpShoppingOrder do
  @moduledoc """
  Order with Accepted Payment Term Response
  ...
  alias Bazaar.Schemas.Common.PaymentTermsResp.OrderPayment
