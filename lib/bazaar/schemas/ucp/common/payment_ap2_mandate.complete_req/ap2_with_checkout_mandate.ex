defmodule Bazaar.Schemas.Common.PaymentAp2MandateCompleteReq.Ap2WithCheckoutMandate do
  @moduledoc """
  Schema
  ...
  def changeset(struct \\ %__MODULE__{}, params) do
    struct |> cast(params, [:checkout_mandate]) |> validate_required([:checkout_mandate])
  end
