defmodule Bazaar.Schemas.Common.PaymentTermsCreateReq.DevUcpShoppingOrder do
  @moduledoc """
  Order with Accepted Payment Term Create Request

  Order extended with the payment term accepted at checkout.

  Generated from: payment_terms.create_req.json
  """
  use Ecto.Schema
  import Ecto.Changeset
  alias Bazaar.Schemas.Common.PaymentTermsCreateReq.OrderPayment
  alias Bazaar.Schemas.Common.Types.TotalsCreateReq
  alias Bazaar.Schemas.Shopping.Types.Adjustment
  alias Bazaar.Schemas.Shopping.Types.OrderLineItem
  alias Bazaar.Schemas.UcpCreateReq.ResponseOrderSchema
  ...
  @field_descriptions %{
    ...
    payment: "Payment details for the Order, including the accepted payment term.",
  ...
  embedded_schema do
    ...
    embeds_one(:payment, OrderPayment)
