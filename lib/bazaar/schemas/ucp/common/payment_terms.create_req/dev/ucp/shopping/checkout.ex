defmodule Bazaar.Schemas.Common.PaymentTermsCreateReq.DevUcpShoppingCheckout do
  @moduledoc """
  Checkout with Payment Terms Create Request
  ...
  alias Bazaar.Schemas.Common.PaymentTermsCreateReq.Payment
