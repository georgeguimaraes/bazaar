defmodule Bazaar.Schemas.Common.PaymentSplitPaymentsCompleteReq.DevUcpShoppingCheckout do
  @moduledoc """
  Checkout with Split Payments Complete Request

  Checkout extended with split payment instrument amounts.

  Generated from: payment_split_payments.complete_req.json
  """
  use Ecto.Schema
