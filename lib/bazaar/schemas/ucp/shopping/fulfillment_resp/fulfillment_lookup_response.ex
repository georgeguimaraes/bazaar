defmodule Bazaar.Schemas.Shopping.FulfillmentResp.FulfillmentLookupResponse do
  @moduledoc """
  Schema
  ...
  alias Bazaar.Schemas.Shopping.FulfillmentResp.FulfillmentLookupProduct
  alias Bazaar.Schemas.UcpResp.ResponseCatalogSchema

  @field_descriptions %{
    actions: "Outstanding extension-defined Actions for this catalog lookup response.",
