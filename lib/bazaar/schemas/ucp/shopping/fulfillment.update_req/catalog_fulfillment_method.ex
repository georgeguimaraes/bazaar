defmodule Bazaar.Schemas.Shopping.FulfillmentUpdateReq.CatalogFulfillmentMethod do
  @moduledoc """
  Catalog Fulfillment Method Update Request
  ...
  alias Bazaar.Schemas.Shopping.Types.FulfillmentOptionBaseUpdateReq
  ...
  embedded_schema do
    ...
    embeds_many(:options, FulfillmentOptionBaseUpdateReq)
  end
