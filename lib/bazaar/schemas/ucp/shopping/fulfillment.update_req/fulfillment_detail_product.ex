defmodule Bazaar.Schemas.Shopping.FulfillmentUpdateReq.FulfillmentDetailProduct do
  @moduledoc """
  Product
  ...
  alias Bazaar.Schemas.Shopping.FulfillmentUpdateReq.FulfillmentVariant
