defmodule Bazaar.Schemas.Shopping.FulfillmentUpdateReq.FulfillmentGetProductResponse do
  @moduledoc """
  Schema
  ...
  alias Bazaar.Schemas.Shopping.FulfillmentUpdateReq.FulfillmentDetailProduct
