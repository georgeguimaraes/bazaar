defmodule Bazaar.Schemas.Shopping.FulfillmentUpdateReq.FulfillmentGetProductRequest do
  @moduledoc """
  Schema
  ...
  alias Bazaar.Schemas.Shopping.FulfillmentUpdateReq.FulfillmentSearchFilters
