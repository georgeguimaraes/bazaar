defmodule Bazaar.Schemas.Shopping.FulfillmentUpdateReq.DevUcpShoppingCheckout do
  @moduledoc """
  ...
  alias Bazaar.Schemas.Shopping.Types.FulfillmentUpdateReq
  ...
  embedded_schema do
    ...
    embeds_one(:fulfillment, FulfillmentUpdateReq)
