defmodule Bazaar.Schemas.Shopping.BuyerConsentUpdateReq.DevUcpShoppingCart do
  @moduledoc """
  Cart with Buyer Consent Update Request
  ...
  alias Bazaar.Schemas.Shopping.BuyerConsentUpdateReq.Buyer
