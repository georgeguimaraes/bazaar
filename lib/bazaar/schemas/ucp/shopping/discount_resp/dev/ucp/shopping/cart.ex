defmodule Bazaar.Schemas.Shopping.DiscountResp.DevUcpShoppingCart do
  @moduledoc """
  Cart with Discount Response
  ...
  alias Bazaar.Schemas.Shopping.DiscountResp.DiscountsObject
