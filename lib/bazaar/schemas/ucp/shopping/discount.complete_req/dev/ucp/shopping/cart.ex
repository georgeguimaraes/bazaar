defmodule Bazaar.Schemas.Shopping.DiscountCompleteReq.DevUcpShoppingCart do
  @moduledoc """
  Cart with Discount Complete Request
  ...
  alias Bazaar.Schemas.Shopping.DiscountCompleteReq.DiscountsObject
