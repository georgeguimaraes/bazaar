defmodule Bazaar.Schemas.Shopping.CatalogLookupCreateReq.GetProductResponse do
  @moduledoc """
  Schema

  Generated from: catalog_lookup.create_req.json
  """
  use Ecto.Schema
  import Ecto.Changeset
  alias Bazaar.Schemas.Common.Types.Policy
  alias Bazaar.Schemas.Shopping.CatalogLookupCreateReq.DetailProduct
