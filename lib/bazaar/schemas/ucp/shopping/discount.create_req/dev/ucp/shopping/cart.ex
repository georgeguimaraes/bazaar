defmodule Bazaar.Schemas.Shopping.DiscountCreateReq.DevUcpShoppingCart do
  @moduledoc """
  Cart with Discount Create Request
  ...
  alias Bazaar.Schemas.Shopping.DiscountCreateReq.DiscountsObject
