defmodule Bazaar.Schemas.Shopping.Types.FulfillmentDestinationUpdateReq do
  @moduledoc """
  Fulfillment Destination Update Request

  A destination for fulfillment.

  Generated from: fulfillment_destination.update_req.json
  """
  use Ecto.Schema
