defmodule Bazaar.Schemas.Shopping.Types.ShippingDestinationUpdateReq do
  @moduledoc """
  Shipping Destination Update Request

  Shipping destination.

  Generated from: shipping_destination.update_req.json
  """
  use Ecto.Schema
