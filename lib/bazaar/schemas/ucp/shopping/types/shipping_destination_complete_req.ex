defmodule Bazaar.Schemas.Shopping.Types.ShippingDestinationCompleteReq do
  @moduledoc """
  Shipping Destination Complete Request

  Shipping destination.

  Generated from: shipping_destination.complete_req.json
  """
  use Ecto.Schema
