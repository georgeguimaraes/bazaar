defmodule Bazaar.Schemas.Shopping.Types.PaymentInstrument.SelectedPaymentInstrument do
  @moduledoc """
  ...
  @field_descriptions %{
    ...
    selected: "Whether this instrument is selected by the user.",
    type:
  ...
  def changeset(struct \\ %__MODULE__{}, params) do
    struct
    |> cast(params, [:display, :handler_id, :id, :selected, :type])
