defmodule Bazaar.Schemas.Shopping.Types.FulfillmentDestinationCreateReq do
  @moduledoc """
  Fulfillment Destination Create Request

  A destination for fulfillment.

  Generated from: fulfillment_destination.create_req.json
  """
  use Ecto.Schema
