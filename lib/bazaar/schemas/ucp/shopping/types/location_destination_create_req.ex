defmodule Bazaar.Schemas.Shopping.Types.LocationDestinationCreateReq do
  @moduledoc """
  Business Location Destination Create Request
  ...
  Generated from: location_destination.create_req.json
  """
  use Ecto.Schema
