defmodule Bazaar.Schemas.Shopping.Types.ShippingDestinationCreateReq do
  @moduledoc """
  Shipping Destination Create Request

  Shipping destination.

  Generated from: shipping_destination.create_req.json
  """
  use Ecto.Schema
