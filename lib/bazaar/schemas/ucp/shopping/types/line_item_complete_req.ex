defmodule Bazaar.Schemas.Shopping.Types.LineItemCompleteReq do
  @moduledoc """
  Line Item Complete Request

  Line item object. Expected to use the currency of the parent object.

  Generated from: line_item.complete_req.json
  """
  use Ecto.Schema
  import Ecto.Changeset
  alias Bazaar.Schemas.Shopping.Types.ItemCompleteReq
  ...
  embedded_schema do
    ...
    embeds_one(:item, ItemCompleteReq)
  end
