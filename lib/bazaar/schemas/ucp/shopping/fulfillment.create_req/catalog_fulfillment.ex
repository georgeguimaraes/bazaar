defmodule Bazaar.Schemas.Shopping.FulfillmentCreateReq.CatalogFulfillment do
  @moduledoc """
  Catalog Fulfillment Create Request
  ...
  alias Bazaar.Schemas.Shopping.FulfillmentCreateReq.CatalogFulfillmentMethod
