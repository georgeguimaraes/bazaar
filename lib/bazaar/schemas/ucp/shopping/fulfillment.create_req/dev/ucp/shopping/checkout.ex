defmodule Bazaar.Schemas.Shopping.FulfillmentCreateReq.DevUcpShoppingCheckout do
  @moduledoc """
  ...
  alias Bazaar.Schemas.Shopping.Types.FulfillmentCreateReq
  ...
  embedded_schema do
    ...
    embeds_one(:fulfillment, FulfillmentCreateReq)
