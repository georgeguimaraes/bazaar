defmodule Bazaar.Schemas.Shopping.FulfillmentCreateReq.FulfillmentSearchResponse do
  @moduledoc """
  Schema
  ...
  alias Bazaar.Schemas.Shopping.FulfillmentCreateReq.FulfillmentProduct
  alias Bazaar.Schemas.UcpCreateReq.ResponseCatalogSchema
  ...
  embedded_schema do
    ...
    embeds_many(:products, FulfillmentProduct)
