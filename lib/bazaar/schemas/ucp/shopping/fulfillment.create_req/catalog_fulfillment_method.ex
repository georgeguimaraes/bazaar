defmodule Bazaar.Schemas.Shopping.FulfillmentCreateReq.CatalogFulfillmentMethod do
  @moduledoc """
  Catalog Fulfillment Method Create Request
  ...
  alias Bazaar.Schemas.Shopping.Types.FulfillmentOptionBaseCreateReq
  ...
  embedded_schema do
    ...
    embeds_many(:options, FulfillmentOptionBaseCreateReq)
  end
