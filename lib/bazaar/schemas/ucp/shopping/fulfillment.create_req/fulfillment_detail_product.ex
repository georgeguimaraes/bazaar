defmodule Bazaar.Schemas.Shopping.FulfillmentCreateReq.FulfillmentDetailProduct do
  @moduledoc """
  Product
  ...
  alias Bazaar.Schemas.Shopping.FulfillmentCreateReq.FulfillmentVariant
