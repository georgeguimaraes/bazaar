defmodule Bazaar.Schemas.Shopping.FulfillmentCompleteReq.FulfillmentGetProductResponse do
  @moduledoc """
  Schema
  ...
  alias Bazaar.Schemas.Shopping.FulfillmentCompleteReq.FulfillmentDetailProduct
