defmodule Bazaar.Schemas.Shopping.FulfillmentCompleteReq.FulfillmentLookupVariant do
  @moduledoc """
  Variant
  ...
  alias Bazaar.Schemas.Shopping.FulfillmentCompleteReq.CatalogFulfillment
  alias Bazaar.Schemas.Shopping.Types.Availability
  alias Bazaar.Schemas.Shopping.Types.Category
  alias Bazaar.Schemas.Shopping.Types.InputCorrelation
  ...
  @field_descriptions %{
    ...
    fulfillment: "How a catalog variant can be fulfilled. Mirrors checkout `fulfillment`.",
  ...
  embedded_schema do
    ...
    embeds_one(:fulfillment, CatalogFulfillment)
    embeds_many(:inputs, InputCorrelation)
