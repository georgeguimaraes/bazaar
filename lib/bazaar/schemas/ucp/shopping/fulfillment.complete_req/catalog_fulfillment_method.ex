defmodule Bazaar.Schemas.Shopping.FulfillmentCompleteReq.CatalogFulfillmentMethod do
  @moduledoc """
  Catalog Fulfillment Method Complete Request
  ...
  alias Bazaar.Schemas.Shopping.Types.FulfillmentOptionBaseCompleteReq
  ...
  embedded_schema do
    ...
    embeds_many(:options, FulfillmentOptionBaseCompleteReq)
  end
