defmodule Bazaar.Schemas.Shopping.FulfillmentCompleteReq.FulfillmentDetailProduct do
  @moduledoc """
  Product
  ...
  alias Bazaar.Schemas.Shopping.FulfillmentCompleteReq.FulfillmentVariant
  ...
  embedded_schema do
    ...
    embeds_many(:variants, FulfillmentVariant)
  end
