defmodule Bazaar.Schemas.Message do
  @moduledoc """
  ...
  ## Example
      ...
      # Warning message
      Bazaar.Schemas.Message.warning(%{
        "code" => "price_changed",
        "content" => "Price has increased since item was added"
      })

      # Info message
      Bazaar.Schemas.Message.info(%{
        "code" => "free_shipping",
  ...
  ## Example
      ...
      Bazaar.Schemas.Message.parse(%{"type" => "error", "code" => "invalid", ...})
      # Routes to error/1

      Bazaar.Schemas.Message.parse(%{"type" => "warning", "code" => "price_changed", ...})
      # Routes to warning/1
  """
