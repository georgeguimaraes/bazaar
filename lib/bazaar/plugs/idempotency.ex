defmodule Bazaar.Plugs.Idempotency do
  ...
  - `:cache` - Cache module to use (default: `Bazaar.Plugs.Idempotency.ETSCache`)
  ...
  @default_opts [
    cache: Bazaar.Plugs.Idempotency.ETSCache,
    ttl: 86_400,
  ...
  defp handle_idempotent_request(conn, key, opts) do
    ...
    case cache.get(cache_key) do
      ...
      :miss ->
        ...
        conn
        |> put_resp_header(header_name, key)
        |> assign(:bazaar_idempotency_key, cache_key)
        |> assign(:bazaar_idempotency_cache, cache)
        |> assign(:bazaar_idempotency_ttl, ttl)
  ...
  defp cache_response(conn) do
    case conn.assigns do
      %{bazaar_idempotency_key: key, bazaar_idempotency_cache: cache, bazaar_idempotency_ttl: ttl} ->
  ...
  defmodule ETSCache do
    ...
    @table :bazaar_idempotency_cache
