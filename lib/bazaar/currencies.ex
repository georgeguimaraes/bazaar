defmodule Bazaar.Currencies do
  @moduledoc """
  ISO 4217 currency codes supported by UCP.
  """
  ...
  @currencies ~w(
    ...
    RWF SAR SBD SCR SDG SEK SGD SHP SLE SLL SOS SRD SSP STN SYP SZL THB TJS TMT
    TND TOP TRY TTD TWD TZS UAH UGX USD UYU UZS VES VND VUV WST XAF XCD XOF XPF
    YER ZAR ZMW ZWL
  )

  @doc "Returns all supported ISO 4217 currency codes."
  def codes, do: @currencies

  @doc "Checks if a currency code is valid."
  def valid?(code) when is_binary(code), do: code in @currencies
