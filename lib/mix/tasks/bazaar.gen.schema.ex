defmodule Mix.Tasks.Bazaar.Gen.Schema do
  ...
  Generates Elixir schema modules from UCP JSON Schema files.
      ...
      $ mix bazaar.gen.schema priv/ucp_schemas/2026-08-25/shopping/types/buyer.json
  ...
  ## Examples
      ...
      # Generate to stdout
      $ mix bazaar.gen.schema priv/ucp_schemas/2026-08-25/shopping/types/total_resp.json

      # Generate with module name
      $ mix bazaar.gen.schema priv/ucp_schemas/2026-08-25/shopping/types/buyer.json --module Bazaar.Schemas.Buyer

      # Generate to file
      $ mix bazaar.gen.schema priv/ucp_schemas/2026-08-25/shopping/checkout_resp.json --output lib/bazaar/schemas/ucp/shopping/checkout.ex
  """
